    ...
    return (
        <div className="relative h-72">
            ...
            <div className="flex flex-col rounded-lg p-4 items-center justify-center absolute w-full h-full">
                ...
                <p className="text-white mb-4 tex-shadow font-semibold text-xl text-center">{post.title}</p>
                <div className="flex items-center absolute bottom-5 w-full justify-center">
                    ...
                    />
                    <p className="inline align-middle text-white text-shadow ml-2 font-medium text-xs">{post.author.name}</p>
                </div>
            </div>
